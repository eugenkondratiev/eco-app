...
class Eco3MonthReport extends Eco1MonthReport {
    constructor(reportMonth, reportYear) {
        ...
        this.HEADER = ["Дата", "Тепло, гкал", "Расход воды, м3",
    ...
    //========================================================================================
    getDayReportSql(day) {
        return `SELECT dt, sum(W_38), sum(q_39),  avg(T_3),  min(T_3), max(T_3), avg(T_18),  min(T_18), max(T_18),
         avg(P_6), avg(T_7), avg(P_8), avg(P_9)
        FROM eco.hourseco3 where dt between '${day}' and DATE_ADD('${day}', INTERVAL 23 hour);`;
        //dt, w_38, q_39, T_41, T_42, T_3, P_19, T_10, P_21, P_34, W_38  FROM eco.hourseco3
    }
    //========================================================================================
