...
class Eco1DayReport extends base {
    constructor(reportDay, reportMonth, reportYear) {
        ...
        this.HEADER_LEGEND = ["dt", "W_38", "Q_39", "T_41", "T_42", "P_19", "P_18", "T_10", "P_36"];
    ...
    getDayReportSql(day, month, year) {
        ...
        return `SELECT ${this.HEADER_LEGEND.join(', ')}
            FROM eco.hourseco${this.eco} where dt between '${startDay}' and DATE_ADD('${startDay}', INTERVAL 23 hour)`;
    }
    //-----------------------------------------------------------------
