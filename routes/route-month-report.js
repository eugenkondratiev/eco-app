...
const monthReport3 = require('../controllers/model/month-report-eco3');
...
router.get('/:ecoId/', function (req, res, next) {
  try {
    ...
    const monthrep = eco === 2
      ? new monthReport2(month, year)
      : eco === 3
        ? new monthReport3(month, year)
        : new monthReport1(month, year);
